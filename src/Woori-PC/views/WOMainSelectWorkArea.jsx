...
const TabArea = styled.div`
  ...
  .tooltip {
    ...
    margin-left: 12px;
    margin-bottom: 11px;
    background: url(/assets/woori-pc//etc/main-select-tooltip.svg) no-repeat center / cover;
  }
`;
// 자주 쓰는 업무
...
const WorkSelectedWrap = styled.div`
  ...
  &::before {
    ...
    width: 24px;
    height: 24px;
    background: url(/assets/woori-pc//icon/main-selected-work-icon.svg) no-repeat center / cover;
  }
`;
