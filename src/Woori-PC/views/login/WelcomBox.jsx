    ...
    <Wrap className='login__welcome-box'>
      ...
      <div className='info-area'>
        ...
        <div className='image-area'>
          <img src='/assets/woori-pc//etc/seoul.svg' alt='I SEOUL U' height='14px' />
          <img src='/assets/woori-pc//etc/woori-bank.svg' alt='우리은행' height='18px' />
        </div>
      </div>
    </Wrap>
  );
...
const Wrap = styled.div`
  ...
  background: url('/assets/woori-pc//etc/logo-login.svg') left -64px bottom -20px / 485px 526px no-repeat, linear-gradient(0deg, #3a3d64 0%, #1d2e4b 100%);
  .title-area {
    .text,
    .sub-text {
      display: block;
