...
const Wrapper = styled.div`
    ...
    .rg-empty-grid {
      span {
        ...
        &::before {
          ...
          width: 90px;
          height: 90px;
          background: url(/assets/woori-pc//etc/table-nonedata.svg) no-repeat center / cover;
        }
      }
    }
  }
  ...
  .rg-checkbox {
    ...
    width: 16px;
    height: 16px;
    background: url(/assets/woori-pc//icon/table-check-default.svg) no-repeat center / cover;
    cursor: pointer;
    &:checked {
      background: url(/assets/woori-pc//icon/table-check-active.svg) no-repeat center / cover;
    }
  }
  .rg-header-check {
  ...
  .rg-cell-buttons {
    ...
    .rg-button-list {
      width: 16px;
      height: 16px;
      background: url(/assets/woori-pc//icon/table-dropdown-arr.svg) no-repeat center / cover;
    }
  }
  .rg-foot-cell {
        ...
        td {
          ...
          &.rg-data-cell:not(.rg-data-readonly-cell):not(.dropdown-cell):not(.calendar-cell) {
            ...
            .rg-renderer:not(.rg-check-renderer) {
              ...
              &::after {
                ...
                width: 16px;
                height: 16px;
                background: url(/assets/woori-pc//icon/table-edit-icon.svg) no-repeat center / cover;
              }
            }
            &.text-right {
              .rg-renderer {
            ...
            &.download {
              .rg-button-renderer-button {
                ...
                &::before {
                  ...
                  width: 16px;
                  height: 16px;
                  background: url(/assets/woori-pc//icon/download.svg) no-repeat center / cover;
                }
              }
            }
            &.text-btn {
          ...
          .rg-renderer {
            ...
            .table-file {
              ...
              width: 16px;
              height: 16px;
              background: url(/assets/woori-pc//icon/table-attachfile.svg) no-repeat center / cover;
            }
            .table-siren {
              display: block;
              margin: 0 auto;
              width: 16px;
              height: 16px;
              background: url(/assets/woori-pc//icon/table-siren.svg) no-repeat center / cover;
            }
          }
          .table-btn {
            display: block;
  ...
  .rg-button-calendar {
    background: url(/assets/woori-pc//icon/calendar.svg) no-repeat center / cover !important;
  }
