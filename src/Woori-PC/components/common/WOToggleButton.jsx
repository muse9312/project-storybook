...
const ToggleBtn = styled(ToggleBtnBaseStyled)`
  ${(props) =>
    props.$isActive
      ? `
        background:url('/assets/woori-pc//icon/${props.$icon}-active.svg') no-repeat center / cover;
  `
      : `background:url('/assets/woori-pc//icon/${props.$icon}.svg') no-repeat center / cover;`}
`;
