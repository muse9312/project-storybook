...
const Line = styled.div`
  ...
  height: 32px;
  margin-left: 22px;
  background: url(/assets/woori-pc//icon/work-line.svg) no-repeat center / cover;
`;

const Icon = styled.div`
  width: 16px;
  height: 16px;
  background: url(/assets/woori-pc//icon/folder-color.svg) no-repeat center / cover;
  ${(props) =>
    props.$hasChildren &&
    css`
      background: url(/assets/woori-pc//icon/folder-color-close.svg) no-repeat center / cover;
      ${props.$depthOepn &&
      css`
        background: url(/assets/woori-pc//icon/folder-color-open.svg) no-repeat center / cover;
      `}
    `}
  ${(props) =>
    props.$type === 'depth2' &&
    css`
      background: url(/assets/woori-pc//icon/folder-white-close.svg) no-repeat center / cover;
    `}
`;
