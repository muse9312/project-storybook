  ...
  ${(props) =>
    props.$width === 164
      ? css`
          width: 164px;
          &.active {
            background: url('/assets/woori-pc//menu/fds-border-full164.svg') no-repeat center / 100%;
          }
        `
      : css`
          &.active {
            background: url('/assets/woori-pc//menu/fds-border-full.svg') no-repeat center / 100%;
          }
        `}
`;
