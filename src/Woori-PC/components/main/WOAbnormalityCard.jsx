...
const Wrap = styled.div`
  ...
  height: 100%;
  padding: 16px 20px;
  /* background: url('/assets/woori-pc//menu/fds-border-transparent.svg') no-repeat center / 100%; */
  ...
  ${(props) =>
    props.$width === 360
      ? css`
          ...
          width: 100%;
          background: url('/assets/woori-pc//menu/fds-border-transparent360.svg') no-repeat center / 100%;
        `
      : css`
          background: url('/assets/woori-pc//menu/fds-border-transparent.svg') no-repeat center / 100%;
        `}
