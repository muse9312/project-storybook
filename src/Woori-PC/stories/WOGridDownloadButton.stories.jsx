...
const WOGridDownloadButtonStory = {
  // 좌측 메뉴 depth
  title: 'WooriPC/Button/WOGridDownloadButton',
  // 컴포넌트 명
    ...
    <>
      ...
      <WOModal isOpen={isOpen} direction='center' height={240} title='다운로드' onClose={() => setIsOpen(false)}>
        <GridDownLoadButtonWrap>
          <WOGridDownloadButton imgUrl={'assets/woori-pc/etc/excel.svg'} fileFormat={'xlsx'} onClick={() => {}} />
          <WOGridDownloadButton imgUrl={'assets/woori-pc/etc/hancell.svg'} fileFormat={'cell'} onClick={() => {}} />
        </GridDownLoadButtonWrap>
      </WOModal>
    </>
  );
