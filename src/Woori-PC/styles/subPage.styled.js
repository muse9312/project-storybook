...
export const EditorArea = styled.div`
  ...
  &::after {
    ...
    height: 52px;
    background: url(/assets/woori-pc//temp/editor-menu.svg) no-repeat left top / cover;
  }
  ...
  ${(props) =>
    ...
    css`
      ...
      &::before,
      &::after {
        background: url(/assets/woori-pc//temp/editor-modal-menu.svg) no-repeat left top / cover;
      }
      &::after {
        background-position: right top;
      }
