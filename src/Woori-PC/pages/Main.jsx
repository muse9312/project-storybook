          ...
          <GuideModalContent>
            <WOTabContent id={1} activeTabId={activeTabID}>
              <div className='img-wrap tab1'>
                {isOption === 1 && <img src={'/assets/woori-pc//temp/guide-contents-1.svg'} alt='guideImg01' />}
                {isOption === 2 && <img src={'/assets/woori-pc//temp/guide-contents-2.svg'} alt='guideImg02' />}
                {isOption === 3 && <img src={'/assets/woori-pc//temp/guide-contents-3.svg'} alt='guideImg03' />}
              </div>
            </WOTabContent>
            <WOTabContent id={2} activeTabId={activeTabID}>
              <div className='img-wrap tab2'>
                <img src={'/assets/woori-pc//temp/guide-contents-4.svg'} alt='guideImg04' />
              </div>
            </WOTabContent>
          </GuideModalContent>
        </div>
