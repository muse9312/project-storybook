      ...
      <S.SignContentWrap>
        <div className='content-box'>
          <S.Container $gap={'unset'}>
            {/* 타이틀 영역 */}
            <S.SignTitleArea>
              <img src='/assets/woori-pc//etc/logo-color.svg' className='logo-image' alt='로고' />
              {selectedTab === 1 && (
                <h3 className='title'>
                  필수항목 및 선택항목 약관에
                  <br /> 동의해 주세요.
                ...
                <S.SignFormArea $position={'relative'} $mgTop={76}>
                  <S.SignAcceptBoxWrap>
                    ...
                    <LoadingWrap isPass={pass}>
                      {pass && <img src='/assets/woori-pc//etc/shape.svg' className='checkmark-animation' alt='Checkmark' />}
                      {!pass && <img src='/assets/woori-pc//etc/rolling.svg' className='rolling-animation' alt='loading...' />}
                    </LoadingWrap>
                  </S.SignAcceptBoxWrap>
                </S.SignFormArea>
                {/* 버튼 영역 */}
